...
function adfoin_elementorpro_get_forms( $form_provider ) {
    ...
    foreach( $result as $single_post ) {
        $elementor_data = json_decode( get_post_meta( $single_post['ID'], '_elementor_data', true ), true );
...
add_action( 'elementor_pro/forms/new_record', 'adfoin_elementorpro_submission', 10, 10 );
