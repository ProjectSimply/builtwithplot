...
add_action( 'metform_pro_form_data_for_pro_integrations', 'adfoin_metform_handle_pro_form_submission', 10, 3 );
...
add_action( 'metform_after_store_form_data', 'adfoin_metform_handle_form_submission', 10, 3 );
    ...
    ?>
        <script type="text/template" id="metform-template">
            <tr valign="top" class="alternate" v-if="trigger.formId">
                ...
                <td>
                    <p>
                        <?php esc_attr_e( 'The basic AFI plugin supports single line and email fields only', 'advanced-form-integration' ); ?>
                    </p>
                </td>
            </tr>
        </script>
