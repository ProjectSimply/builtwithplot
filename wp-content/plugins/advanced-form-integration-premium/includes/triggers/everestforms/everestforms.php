...
add_action( 'everest_forms_process_complete', 'adfoin_everestforms_submission', 30, 4 );

function adfoin_everestforms_submission( $form_fields, $entry, $form_data, $entry_id ) {
