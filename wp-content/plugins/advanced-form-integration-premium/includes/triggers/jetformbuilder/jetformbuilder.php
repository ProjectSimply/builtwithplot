...
add_action( 'jet-form-builder/form-handler/after-send', 'adfoin_jet_form_builder_submit', 10, 2 );
    ...
    ?>
        <script type="text/template" id="jetformbuilder-template">
            <tr valign="top" class="alternate" v-if="trigger.formId">
                ...
                <td>
                    <p>
                        <?php esc_attr_e( 'The basic AFI plugin supports text field only', 'advanced-form-integration' ); ?>
                    </p>
                </td>
            </tr>
        </script>
