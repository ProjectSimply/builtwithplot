...
* **[BuddyBoss](https://www.buddyboss.com/)**: Triggers on various BuddyBoss events, such as friendship requests or acceptance, new topics or replies, joining or leaving a group, membership requests or acceptance, and more.
...
* **[GiveWP](https://wordpress.org/plugins/give/)**: This triggers several events in GiveWP, such as a new donation, canceling recurring, etc.
...
* **[TutorLMS](https://wordpress.org/plugins/tutor/)**: Triggers on enrollment, lesson completion, course completion, and quiz attempts.

* **[QuForm](https://advancedformintegration.com/docs/afi/sender-platforms/quform/)**
