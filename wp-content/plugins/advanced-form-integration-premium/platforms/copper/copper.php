...
function adfoin_copper_settings_view( $current_tab ) {
    ...
    <form name="copper_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"> <?php _e( 'Admin Email', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_copper_user_email"
                           value="<?php echo esc_attr( $user_email ); ?>" placeholder="<?php _e( 'Please enter User Email', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_copper_access_token"
                           value="<?php echo esc_attr( $access_token ); ?>" placeholder="<?php _e( 'Please enter Access Token', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                           <p class="description" id="code-description"><?php _e( 'Please go to Settings > Integrations > API Keys', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'add_contact'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Copper [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
...
function adfoin_copper_request( $endpoint, $method, $data = array(), $record = array() ) {
