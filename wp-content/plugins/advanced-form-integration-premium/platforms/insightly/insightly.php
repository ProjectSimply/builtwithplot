            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_insightly_api_key"
                           ...
                           class="regular-text"/>
                           <p class="description" id="code-description"><?php _e( 'Go to User Settings to get the API Key and URL', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_insightly_api_url"
                           value="<?php echo esc_attr( $api_url ); ?>" placeholder="<?php _e( 'Please enter API URL', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
        </table>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'add_contact'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Insightly [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
