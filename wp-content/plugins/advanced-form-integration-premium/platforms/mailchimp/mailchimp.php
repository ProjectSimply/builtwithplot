                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Mailchimp [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
 ...
 */
function adfoin_mailchimp_request( $endpoint, $method, $data = array(), $record = array() ) {
...
function adfoin_mailchimp_send_data( $record, $posted_data ) {
    ...
    if( $task == "subscribe" ) {
        ...
        $return   = adfoin_mailchimp_request( $endpoint, 'POST', $subscriber_data, $record );
    }
    ...
    if( $task == 'unsubscribe' ) {
        ...
        if( !is_wp_error( $member ) ) {
            ...
            $return    = adfoin_mailchimp_request( $unsub_end, 'DELETE', array(), $record );
