                    ...
                    if ( adfoin_fs()->is__premium_only() ) {
                        if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                            ...
                            <input type="text" name="adfoin_hubspot_access_token"
                                ...
                                class="regular-text"/>
                            <p class="description" id="code-description"><?php _e( '1. Go to Settings > Integrations > Private Apps.<br>
                            2. Click on the <b>Create a private app</b> button.<br>
                            3. Go to the Scopes tab, and select required scopes.<br>
                            4. Click on the Create button.<br>
                            5. Click on <b>Show token</b> and copy the key.', 'advanced-form-integration' ); ?></p>
                        </td>
                            <?php
                        }
                    }
