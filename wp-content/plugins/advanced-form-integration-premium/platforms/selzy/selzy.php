...
function adfoin_selzy_settings_view( $current_tab ) {
    ...
    <form name="selzy_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_selzy_api_key"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Go to Profile > Settings > Integrations & API. Click on show full and copy the API Key', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
...
add_action( 'admin_post_adfoin_save_selzy_api_key', 'adfoin_save_selzy_api_key', 10, 0 );
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Selzy [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
 ...
 * Selzy API Request
 */
function adfoin_selzy_request( $endpoint, $method = 'GET', $data = array(), $record = array() ) {
