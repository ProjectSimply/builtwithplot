    ...
    public function adfoin_aweber_settings_view( $current_tab ) {
        ...
        <form name="aweber_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"> <?php _e( 'Authorization Code', 'advanced-form-integration' ); ?></th>
                    <td>
                        <input type="hidden" name="adfoin_aweber_code_verifier" value="<?php echo $this->code_verifier; ?>" />
                        <input type="hidden" name="adfoin_aweber_code_challenge" value="<?php echo $this->code_challenge; ?>" />
                        <input type="text" name="adfoin_aweber_auth_code"
                               value="<?php echo esc_attr( $auth_code ); ?>" placeholder="<?php _e( 'Enter Authorization Code', 'advanced-form-integration' ); ?>"
                               class="regular-text"/>
                        <p class="description" id="code-description"><a
                                href="<?php echo esc_url( $url ); ?>"
                                target="_blank" rel="noopener noreferrer"><?php _e( 'Click here to get the code', 'advanced-form-integration' ); ?></a></p>
                    </td>
                </tr>

            </table>
            <?php submit_button( __( 'Save', 'advanced-form-integration' ) ); ?>
        </form>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Aweber [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
