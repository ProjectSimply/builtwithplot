            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_moosend_api_token"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Go to Settings > API Key to get API Key', 'advanced-form-integration' ); ?></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Moosend [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
...
*/
function adfoin_moosend_request( $endpoint, $method = 'GET', $data = array(), $record = array() ) {
