            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_activecampaign_url"
                           value="<?php echo esc_attr( $url ); ?>" placeholder="<?php _e( 'Please enter URL', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                    <p>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_activecampaign_api_key"
                           value="<?php echo esc_attr( $api_key ); ?>" placeholder="<?php _e( 'Please enter Key', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                    <p>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use advanced features, please create a <a href="%s">new integration</a> and select ActiveCampaign[PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
 ...
 */
function adfoin_activecampaign_request($endpoint, $method = 'GET', $data = array(), $record = array()) {
