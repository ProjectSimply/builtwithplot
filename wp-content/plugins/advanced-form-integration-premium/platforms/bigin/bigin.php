...
class ADFOIN_Bigin extends Advanced_Form_Integration_OAuth2 {
    ...
    public function __construct() {
        ...
        add_action( 'admin_post_adfoin_save_bigin_keys', array( $this, 'adfoin_save_bigin_keys' ), 10, 0 );
    ...
    public function adfoin_bigin_settings_view( $current_tab ) {
        ...
        <form name='bigin_save_form' action='<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>'
                    ...
                    if ( adfoin_fs()->is__premium_only() ) {
                        if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                            ...
                            <tr valign="top" v-if="action.task == 'subscribe'">
                                ...
                                <td scope="row">
                                    <span><?php printf( __( 'To use custom fields please create a <a href="%s">new integration</a> and select Bigin [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                                </td>
                            </tr>
                            <?php
                        }
