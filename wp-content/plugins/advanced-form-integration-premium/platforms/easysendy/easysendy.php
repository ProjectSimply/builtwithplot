...
function adfoin_easysendy_settings_view( $current_tab ) {
    ...
    <form name="easysendy_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use custom fields, please create a <a href="%s">new integration</a> and select EasySendy [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
 ...
 * EasySendy Request
 */
function adfoin_easysendy_request($endpoint, $method = 'GET', $data = array(), $record = array())
{
...
function adfoin_easysendy_send_data( $record, $posted_data ) {
    ...
    if( $task == 'subscribe' ) {
        ...
        $return = adfoin_easysendy_request( 'subscriber/add', 'POST', $data, $record );
    }
