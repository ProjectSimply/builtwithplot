...
function adfoin_clickup_settings_view( $current_tab ) {
    ...
    <form name="clickup_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" class="container">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_clickup_api_token"
                           value="<?php echo esc_attr( $api_token ); ?>" placeholder="<?php _e( 'Please enter the API Token', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                    <p>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'create_task'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use custom fields, please create a <a href="%s">new integration</a> and select ClickUp [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
 ...
 * Clickup API Request
 */
function adfoin_clickup_request($endpoint, $method = 'GET', $data = array(), $record = array()) {
