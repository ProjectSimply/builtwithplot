            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_agilecrm_email"
                           value="<?php echo esc_attr( $email ); ?>" placeholder="<?php _e( 'Please enter User Eamil', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'add_contact'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Agile CRM [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
