...
function adfoin_salesflare_settings_view( $current_tab ) {
    ...
    <form name="salesflare_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_salesflare_api_token"
                        ...
                        class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Go to Settings > API keys > Click on the plus button and generate a new API key', 'advanced-form-integration' ); ?></a></p>
                </td>
...
add_action( 'admin_post_adfoin_save_salesflare_api_token', 'adfoin_save_salesflare_api_token', 10, 0 );
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'add_data'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use tags and custom fields, please create a <a href="%s">new integration</a> and select Salesflare [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
 ...
 */
function adfoin_salesflare_request( $endpoint, $method = 'GET', $data = array(), $record = array() ) {
