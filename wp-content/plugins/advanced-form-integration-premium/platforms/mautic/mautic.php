...
function adfoin_mautic_settings_view( $current_tab ) {
    ...
    <form name="mautic_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <tr valign="top">
            ...
            <tr valign="top">
                <th scope="row"> <?php _e( 'Mautic Account URL', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_mautic_url"
                           value="<?php echo esc_attr( $credentials['url'] ); ?>" placeholder="<?php _e( 'Enter account URL', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_mautic_username"
                           value="<?php echo esc_attr( $credentials['username'] ); ?>" placeholder="<?php _e( 'Username', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_mautic_password"
                           value="<?php echo esc_attr( $credentials['password'] ); ?>" placeholder="<?php _e( 'Password', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'add_contact'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Mautic [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
...
function adfoin_mautic_send_data( $record, $posted_data ) {
    ...
    if( $task == 'add_contact' ) {
        ...
        $return = adfoin_mautic_request( '/api/contacts/new', 'POST', $data, $record );
    }
...
function adfoin_mautic_request( $endpoint, $method = 'GET', $data = array(), $record = array() ) {
