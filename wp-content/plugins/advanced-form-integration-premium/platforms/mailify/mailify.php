            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_mailify_account_number"
                           value="<?php echo esc_attr( $account_number ); ?>" placeholder="<?php _e( 'Enter Account Number', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_mailify_key"
                           value="<?php echo esc_attr( $key ); ?>" placeholder="<?php _e( 'Enter Key', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
            ...
            <?php
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Mailify [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
                ...
                if(adfoin_fs()->is_not_paying() ){
                    ...
                    <tr valign="top" v-if="action.task == 'subscribe'">
                        ...
                        <td scope="row">
                            <span><?php printf( __( 'To unlock all fields consider <a href="%s">upgrading to Pro</a>.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-settings-pricing') ); ?></span>
                        </td>
                    </tr>
                    <?php
                }
