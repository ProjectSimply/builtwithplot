...
function adfoin_mailbluster_settings_view( $current_tab ) {
    ...
    <form name="mailbluster_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_mailbluster_api_token"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Go to Settings > API Keys and create new API Key', 'advanced-form-integration' ); ?></a></p>
                </td>
...
add_action( 'admin_post_adfoin_save_mailbluster_api_token', 'adfoin_save_mailbluster_api_token', 10, 0 );
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select MailBluster [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
 ...
 */
function adfoin_mailbluster_request( $endpoint, $method = 'GET', $data = array(), $record = array() ) {
