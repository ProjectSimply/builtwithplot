...
class ADFOIN_ZohoCRM extends Advanced_Form_Integration_OAuth2 {
    ...
    public function __construct() {
        ...
        // if( version_compare( ADVANCED_FORM_INTEGRATION_VERSION, '1.83.0', '>=' ) ) {
        ...
        add_action( 'admin_post_adfoin_save_zohocrm_keys', array( $this, 'adfoin_save_zohocrm_keys' ), 10, 0 );
    ...
    public function create_webhook_route() {
        register_rest_route( 'advancedformintegration', '/zohocrm',
            array(
                'methods'             => 'GET',
    ...
    */
            ...
            <div id="post-body" class="metabox-holder columns-2">
                ...
                <div id="post-body-content">
                    <div class="meta-box-sortables ui-sortable">
                            ...
                            <h2 class="hndle"><span><?php esc_attr_e( 'Zoho Accounts', 'advanced-form-integration' ); ?></span></h2>
                            <div class="inside">
                                <div id="zohocrm-auth">
                    ...
                    if ( adfoin_fs()->is__premium_only() ) {
                        if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                            ...
                            <tr valign="top" v-if="action.task == 'subscribe'">
                                ...
                                <td scope="row">
                                    <span><?php printf( __( 'To use custom fields and tags, please create a <a href="%s">new integration</a> and select Zoho CRM [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                                </td>
                            </tr>
                            <?php
                        }
    ...
    protected function save_data() {
        ...
        //read credentials by 'zohocrm' update the array by 'id' and save credentials
        $zoho_credentials = adfoin_read_credentials( 'zohocrm' );

        //loop throught he zoho_credentials and update the access_token and refresh_token by 'id'
        foreach( $zoho_credentials as &$value ) {
    ...
    */
    public function get_modules() {
        ...
        if ( !empty( $response_body['modules'] ) && is_array( $response_body['modules'] ) ) {
            ...
            $skip_list = array( 'Quotes', 'Sales_Orders', 'Purchase_Orders', 'Invoices', 'Projects', 'Notes' );
    ...
    */
    ...
    public function is_duplicate( $module, $holder, $record ) {
        ...
        if( 'Accounts' == $module ) {
            $account_id = $this->search_record( 'Accounts', 'Account_Name', $holder['Account_Name'], $record )['id'];
...
function adfoin_zohocrm_send_data( $record, $posted_data ) {
    ...
    if( $task == 'subscribe' ) {
        ...
        if( $module && $holder ) {
            ...
            $return = $zohocrm->zohocrm_request( $module . '/upsert', 'POST', $request_data, $record );
