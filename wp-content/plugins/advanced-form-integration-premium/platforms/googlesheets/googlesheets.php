                    ...
                    <td>
                        <p>
                            <?php _e( '1. Go to <a target="_blank" rel="noopener noreferrer" href="https://console.developers.google.com/">Google Developer Console</a> and create a <b>New Project</b><br>
                                      ...
                                      <?php _e( '(For more detailed instructions, check <a target="_blank" rel="noopener noreferrer" href="https://advancedformintegration.com/docs/afi/receiver-platforms/google-sheets/">the documentation</a>.)', 'advanced-form-integration' ); ?>
                        </p>
                    </td>
                </tr>
                <tr valign="top">
    ...
    public function get_spreadsheet_list() {
        ...
        if ( adfoin_fs()->is__premium_only() ) {
            if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                $endpoint = "https://www.googleapis.com/drive/v3/files?q=mimeType%20%3D%20'application%2Fvnd.google-apps.spreadsheet'&pageSize=1000&supportsAllDrives=true&includeItemsFromAllDrives=true&access_token=" . $this->access_token;
            }
        }
