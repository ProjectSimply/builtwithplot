            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p class="description" id="code-description"><a
                            ...
                            target="_blank" rel="noopener noreferrer"><?php _e( 'Click here to get API Key.', 'forms-to-sendinblue' ); ?></a> <?php _e( 'Use V3 key', 'forms-to-sendinblue' ); ?></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
                ...
                if ( adfoin_fs()->is__premium_only() ) {
                    if ( adfoin_fs()->is_plan( 'professional', true ) ) {
                        ...
                        <tr valign="top" v-if="action.task == 'subscribe'">
                            ...
                            <td scope="row">
                                <span><?php printf( __( 'To use the Pro features, please create a <a href="%s">new integration</a> and select Sendinblue [PRO] in the action field.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-new') ); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
